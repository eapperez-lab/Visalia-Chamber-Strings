...
import { Calendar, MapPin, Music, Heart, GraduationCap, Users, ExternalLink, Menu, X, Mail } from 'lucide-react';
import './styles.css';
...
const musicians = [
  ...
  { name: 'Chen Zhao', role: 'Guest Artist / Violin', bio: 'A seasoned performer with the San Francisco Symphony and an active soloist, recitalist, chamber musician, and educator.' },
  { name: 'Fiona Cunninghame-Murray', role: 'Violin', bio: 'A violinist pursuing her Master’s at the San Francisco Conservatory of Music, with recent performances alongside Joshua Bell and the Academy of St Martin in the Fields.' },
    ...
    <main>
      ...
      <section id="top" className="hero">
        <div className="hero-content">
          <p className="eyebrow">Visalia Chamber Strings</p>
          <h1>Elevating chamber music in California’s Central Valley.</h1>
          <p className="hero-copy">World-class performances, meaningful student experiences, and intimate concerts designed to inspire the Visalia community.</p>
          <div className="button-row">
            ...
            <a className="button secondary" href="#mission">Our Mission</a>
          </div>
        </div>
        <div className="hero-card">
          <img src="/vcs-red-logo.png" alt="Visalia Chamber Strings red logo" />
        </div>
      </section>
